const features = [
  ...
  },
  {
    ...
    desc: "Sterling silver & fine materials",
  },
  {
    icon: (
      <svg
          ...
          {features.map((f) => (
            <div key={f.title} className="flex flex-col items-center text-center">
              <div
                ...
                style={{ backgroundColor: "#F5E6D0", color: "#8B6914" }}
              >
                {f.icon}
              </div>
              <h3
...
export default WhyCharmProject
